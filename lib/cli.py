...
def menu():
    ...
    print("1. List all crew in a flight")
    print("2. Find crew member by name")
    print("3. Find crew member by id")
    print("4. Create a new crew member")
    print("5. Update a crew member")
    print("6. Delete a crew member")
    print("-----------------------------")
    print("         FLIGHT CLI         ")
    print("-----------------------------")
